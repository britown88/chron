...
EGAColor egaTextureGetColorAt(EGATexture *self, EGARegion *vp, u32 x, u32 y);

void egaClear(EGATexture *target, EGARegion *vp, EGAPalIdx color);
...
void egaRenderPoint(EGATexture *target, EGARegion *vp, int x, int y, EGAPalIdx color);
void egaRenderLine(EGATexture *target, EGARegion *vp, int x1, int y1, int x2, int y2, EGAPalIdx color);
void egaRenderLineRect(EGATexture *target, EGARegion *vp, int left, int top, int right, int bottom, EGAPalIdx color);
void egaRenderRect(EGATexture *target, EGARegion *vp, int left, int top, int right, int bottom, EGAPalIdx color);

void egaRenderCircle(EGATexture *target, EGARegion *vp, int x, int y, int radius, EGAPalIdx color);
void egaRenderEllipse(EGATexture *target, EGARegion *vp, int xc, int yc, int width, int height, EGAPalIdx color);
void egaRenderEllipseQB(EGATexture *target, EGARegion *vp, int xc, int yc, int radius, EGAPalIdx color, double aspect);
