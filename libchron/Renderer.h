...
//note this this actually a gluint
typedef u32 UBOSlot;
...
static Model *CONCAT(NAME, _CreateModel)(NAME *data, u32 vCount, ModelStreamType type) { \
   VertexAttribute *attrs = CONCAT(NAME, _GetAttrs)(); \
   return __modelCreate((void*)data, sizeof(NAME), vCount, attrs, type); \
} \
static void CONCAT(NAME, _UpdateModel)(Model *self, NAME *data, u32 vCount){ \
